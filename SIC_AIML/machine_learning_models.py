...
class TextClassifier:
    ...
    def train_and_evaluate_model(self, train_folder, test_folder, model_save_path):
        # Load data
...
rf_classifier.train_and_evaluate_model(train_folder, test_folder, "random_forest_model.joblib")

# Train and evaluate XGBoost model
xgb_classifier = TextClassifier(model_type='XGBClassifier')
xgb_classifier.train_and_evaluate_model(train_folder, test_folder, "xgb_model.joblib")

# Train and evaluate Naive Bayes model
nb_classifier = TextClassifier(model_type='NaiveBayes')
nb_classifier.train_and_evaluate_model(train_folder, test_folder, "naive_bayes_model.joblib")
